...
function popOpen(id){
    ...
    var popHeight = $('.popup').innerHeight();
    var popHeaderHeight = $('.popup .pop-head').outerHeight();
    var popFootHeight = $('.popup .pop-foot').outerHeight();

    $('.popup .pop-cont').outerHeight(popHeight - popHeaderHeight - popFootHeight);
}
